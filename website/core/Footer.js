    ...
    return (
      <footer className="nav-footer" id="footer">
        <section className="sitemap">
          ...
          <div>
            <h5>Social</h5>
            <a href="http://twitter.com/terminaldotco" target="_blank">
              <svg
                className="supportLinks-github-pic"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512"
