...
class Index extends React.Component {
  render() {
    ...
    const Features = () => (
      ...
      //   <a className="featureBox-link" href="https://google.com">
      //     <div className="featureBox">
      //       <div className="featureBox-pic">pic</div>
      //       <div className="featureBox-title">title</div>
      //     </div>
      //   </a>
      // </div>
      ...
      //       image: `${baseUrl}img/lightbulb-on-light.svg`,
      //       imageAlign: 'top',
      //       title: 'Tutorials',
      ...
      //       image: `${baseUrl}img/rocket-light.svg`,
      //       imageAlign: 'top',
      //       title: 'Getting Strated',
      //     },
      //     {
      //       // content: 'The content of my second feature',
      //       image: `${baseUrl}img/book-light.svg`,
      //       imageAlign: 'top',
      //       title: 'API Reference',
      //     },
      //   ]}
